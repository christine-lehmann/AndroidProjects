...
public class BankAdapter extends RecyclerView.Adapter<BankAdapter.BankAdapterVh> implements Filterable {
    ...
    @NonNull
    @Override
    public BankAdapter.BankAdapterVh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
        return new BankAdapterVh(LayoutInflater.from(context).inflate(R.layout.row, null));
    }

    @Override
    public void onBindViewHolder(@NonNull BankAdapter.BankAdapterVh holder, int position) {
