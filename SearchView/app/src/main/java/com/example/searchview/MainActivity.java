...
public class MainActivity extends AppCompatActivity implements BankAdapter.SelectedBank {
    Toolbar toolbar;
    ...
    public void selectedBank(BankModel bankModel) {
        ...
        startActivity(new Intent(MainActivity.this, SendMoneyActivity.class).putExtra("data",bankModel));
